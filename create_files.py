"""Script to create all metering service files including Feature 2."""
...
print("Creating Feature 2 files...")

# Create providers/__init__.py
with open("app/providers/__init__.py", "w", encoding="utf-8") as f:
    f.write('''"""Carbon intensity providers."""

from .intensity_base import IntensityPoint, IntensityProvider, IntensitySeries

__all__ = ["IntensityPoint", "IntensityProvider", "IntensitySeries"]
''')

# Create providers/intensity_base.py  
with open("app/providers/intensity_base.py", "w", encoding="utf-8") as f:
    f.write('''"""Base interface and models for carbon intensity providers."""
...
print("✅ Feature 2 files created successfully!")
print("\\nNext: pip install httpx cachetools")
print("Then: python -m app.main")


# Create __init__.py
with open("app/__init__.py", "w", encoding="utf-8") as f:
    f.write('''"""Compute Metering Service - Energy and CO2 measurement for shell commands."""

__version__ = "1.0.0"
''')

# Create settings.py
with open("app/settings.py", "w", encoding="utf-8") as f:
    f.write('''"""Configuration settings for the Compute Metering Service."""
...
with open("app/models.py", "w", encoding="utf-8") as f:
    f.write('''"""Data models for the Compute Metering Service."""
...
# Create tracker.py
with open("app/tracker.py", "w", encoding="utf-8") as f:
    f.write('''"""Run tracking and metering logic using CodeCarbon."""
...
with open("app/main.py", "w", encoding="utf-8") as f:
    f.write('''"""FastAPI application for the Compute Metering Service."""
...
app = FastAPI(
    ...
    description="Measure energy and CO2 emissions of shell commands using CodeCarbon",
    version="1.0.0",
    lifespan=lifespan
)
